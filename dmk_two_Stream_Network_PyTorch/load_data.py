...
##公开数据集
trainset = UCF101Data(RBG_root='data/IEEE/RGB', OpticalFlow_root='data/IEEE/OpticalFlow', data_class="train", transform=transform_train, action_num=4)
# 加载数据集中划分的测试数据集
...
# 加载数据集中划分的测试集数据集
###自己数据集
# testset = UCF101Data(RBG_root='data/RGB', OpticalFlow_root='data/OpticalFlow', data_class="test", transform=transform_test,action_num=5)
###公开数据集
testset = UCF101Data(RBG_root='data/IEEE/RGB', OpticalFlow_root='data/IEEE/OpticalFlow', data_class="test", transform=transform_test,action_num=4)
