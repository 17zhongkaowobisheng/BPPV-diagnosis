function C = calOpticalFlow(UCF101_dir_path, RGB_Dir_Path, OpticalFlow_Dir_Path, rgb_save_interval, flow_save_interval)

% UCF101_dir_path = 'D:\Ѹ������\UCF2';
UCF101_dir = dir(UCF101_dir_path);

% dir used to save the RGB images & the optical OpticalFlow images
% RGB_Dir_Path= 'D:\Ѹ������\RGB\';
% OpticalFlow_Dir_Path= 'D:\Ѹ������\Flow\';
...
for i=3:length(UCF101_dir)
    ...
    for j = 3:length(class_dir)
        ...
        while hasFrame(vidReader)
            ...
            %����RGBͼ��ÿ��rgb_save_interval-1֡����һ��
            if mod(i_frame, rgb_save_interval) == 0
                % save RGB
            ...
            %����flowͼ��ÿ��flow_save_interval-1֡����һ��,����x��y�����ϵ�ͼƬ
            if mod(i_frame, flow_save_interval) == 0
                %save Optical Flow
